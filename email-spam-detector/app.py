...
<head>
  ...
  <style>
    ...
    * {{ box-sizing: border-box; }} body {{ margin:0; min-height:100vh; background:#f5f8fc; color:var(--ink); font-family:system-ui,-apple-system,BlinkMacSystemFont,\"Segoe UI\",sans-serif; }}
    ...
    .eyebrow {{ color:var(--blue); font-weight:750; letter-spacing:.08em; font-size:.78rem; text-transform:uppercase; }}
...
<body>
  <main>
    <div class=\"eyebrow\">Beginner AI project</div>
    ...
    <footer>Model: {html.escape(MODEL_INFO['algorithm'])}. Trained on {MODEL_INFO['training_messages']} labelled example messages. Run <code>python train.py</code> after replacing the sample dataset.</footer>
  </main>
</body>
</html>"""
